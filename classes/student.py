class Student:
        ...
        class Student:
            school="AkiraChiX"
        def _init_(self,first_name,last_name,age,country,name,nationality):
    ...
    #     current_year=current_year.now().year
...
# Call each of the methods you defined. -->
        ...
        #     # return f "Hello {sef.name};welcome to
        #     # {self.school},proud{nationality}